  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 w-full" style={{ maxWidth: 480 }}>
        ...
        >
          ...
          >
            ...
            5 Rangers · 6-Layer Data Guard System
          </motion.div>
          ...
          <motion.p
            ...
            style={{ color: '#94a3b8' }}
          >
            AI BRAND &amp; MARKETING PLATFORM · ภาษาไทย
          </motion.p>
        </motion.div>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="inline-flex items-center gap-3 font-semibold text-base relative overflow-hidden"
            style={{
              background: '#5E9BEB',
              borderRadius: 999,
              color: '#fff',
          ...
          >
            ...
            />
            <span className="relative">เริ่มสร้าง</span>
          </motion.button>
      ...
      <motion.p
        ...
        style={{ color: '#cbd5e1' }}
      >
        © 2025 Agent Rangers × iDEAS365 · Powered by Claude AI
      </motion.p>
    </div>
  );
};
